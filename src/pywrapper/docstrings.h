...
PyDoc_STRVAR(imwrite__doc__,
             "imwrite(array, filename, verbosity=0)\n"
             "--\n\n"
...
PyDoc_STRVAR(bw__doc__,
             "gen_psf_bw(NA=None, ni=None, dx=None, dz=None, emission=None, nplanes=, size=, verbose=0)\n"
             "--\n\n"
...
PyDoc_STRVAR(deconvolve__doc__,
             "deconvolve(image, psf, iterations=0, gpu=False, verbosity=0,  bq=2, gpu=False)\n"
             "--\n\n"
             "Write a 2D or 3D fp32 numpy array as a tif file\n"
             "\n"
             "Using libtiff in the background\n");
