...
dw_OBJECTS = fim.o tiling.o fft.o fim_tiff.o dw.o deconwolf.o deconwolf_tif_max.o method_eve.o method_identity.o method_rl.o method_ave.o method_shb.o dw_imshift.o
