...
dw_OBJECTS = fim.o tiling.o fft.o fim_tiff.o dw.o deconwolf.o dw_maxproj.o method_eve.o method_identity.o method_rl.o method_ave.o method_shb.o dw_imshift.o fft.o dw_otsu.o dw_dots.o fwhm.o ftab.o
