...
Amazingly deconwolf works with GPU acceleration out of the box. The
following was required for a build on a fresh system:

Install `homebrew <https://brew.sh/>`__. Then, in the terminal install
...
TODO:
when installing and trying to run we get
dyld[11935]: Library not loaded: @rpath/libkdtree.dylib
